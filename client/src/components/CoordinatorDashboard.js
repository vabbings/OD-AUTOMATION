...
const CoordinatorDashboard = () => {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#E5D9F2' }}>
      
      {/* Header */}
      <div className="bg-purple-100 shadow-lg border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <h1 className="text-3xl font-extrabold text-purple-900 flex items-center group hover:scale-105 transition-transform duration-300">
            ...
            <button
              ...
              className="px-6 py-3 text-sm font-bold text-white bg-indigo-600 hover:bg-indigo-700 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center group"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-purple-50 shadow-lg rounded-xl border border-purple-200 overflow-hidden hover:shadow-xl transition-all duration-300">
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-purple-50 divide-y divide-purple-200">
        ...
        {/* Success Message */}
        {successMessage && (
          <div className="fixed top-4 right-4 bg-purple-100 border-l-4 border-purple-500 text-purple-700 px-6 py-4 rounded-2xl shadow-xl z-50 animate-fade-in hover:shadow-2xl transition-all duration-300">
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-3 text-purple-500 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24">
