...
const LandingPage = () => {
  ...
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-center bg-cover bg-center bg-no-repeat relative overflow-hidden"
      style={{
        backgroundImage: `linear-gradient(rgba(210, 200, 240, 0.85), rgba(210, 200, 240, 0.85)), url('/landing-bg.jpg')`,
