...
const StudentView = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const requiredFields = ['name', 'enrollmentNumber', 'email', 'subjectCode', 'facultyCode', 'date', 'timeFrom', 'timeTo', 'reason'];
  ...
  if (success) {
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: '#E5D9F2' }}>
        <div className="text-center bg-purple-100 p-8 rounded-xl shadow-lg">
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className="bg-purple-100 shadow-lg border-b border-purple-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <h1 className="text-3xl font-extrabold text-purple-900 animate-slide-down flex items-center group hover:scale-105 transition-transform duration-300">
              <svg className="w-10 h-10 mr-3 text-purple-600 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              onClick={() => navigate('/')}
              className="px-6 py-3 text-sm font-bold text-purple-700 bg-purple-100 hover:bg-purple-200 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl flex items-center group"
            >
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-10 animate-fade-in">
          <h2 className="text-3xl font-extrabold text-purple-900 mb-3 animate-slide-down hover:text-purple-600 transition-colors duration-300">
            OD Request Form
          </h2>
          <p className="text-blue-900 animate-slide-up font-medium text-lg">
            Fill in your details with proper validation rules
          </p>
        </div>

        {/* Request Form */}
        <div className="bg-purple-50 rounded-3xl shadow-xl p-8 border border-purple-200 hover:shadow-2xl transition-all duration-500">
          {error && (
            ...
            <div className="group">
              <label htmlFor="date" className="block text-sm font-bold text-purple-900 mb-2.5 group-hover:text-purple-600 transition-colors duration-300">
                Date *
              </label>
              <input
                type="date"
                ...
                className="w-full px-4 py-3 bg-purple-50 border border-purple-200 rounded-xl focus:outline-none focus:ring-4 focus:ring-purple-500 focus:border-transparent shadow-sm transition-all duration-300 group-hover:shadow-md"
            ...
            <div className="group">
              <label htmlFor="email" className="block text-sm font-bold text-gray-900 mb-2.5 group-hover:text-indigo-600 transition-colors duration-300">
                Email *
              </label>
              <input
                type="email"
